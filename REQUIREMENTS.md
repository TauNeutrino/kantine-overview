...
| FR-123 | Das System muss das Hauptgericht eines Menüs (zweiter Gang; bei Ein-Gang-Menüs dieser Gang) bei sicherer Sprachtrennung (Splitter-Konfidenz 'high') als auslösenden Link innerhalb der Menübeschreibung anbieten. Im ALL-Sprachmodus und bei template-/geringerer Konfidenz darf kein Link erscheinen. | Mittel | v2.1.2 |
