...
| `de-DE/short_description.txt` | German | Wochenübersicht der Kantine mit DE/EN-Menüerkennung. (48 chars) |
| `en-US/short_description.txt` | English | Weekly canteen menu with DE/EN language detection. (51 chars) |
...
- **Location**: `fastlane/metadata/android/images/featureGraphic.png`
- **Required size**: 1024 x 500 pixels
- **Format**: PNG
- **Current state**: SVG placeholder created at `featureGraphic.svg`
- **Conversion needed**: Convert SVG to PNG using a tool like Inkscape, Illustrator, or an online converter
