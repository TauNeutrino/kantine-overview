...
const CLIENT_VERSION = 'v2.0.6';
const COMMIT_HASH = '51b45d3';
...
function checkBootloaderVersion() {
    ...
    if (bootVer && !(0,_utils_js__WEBPACK_IMPORTED_MODULE_1__/* .isNewer */ .U4)(_constants_js__WEBPACK_IMPORTED_MODULE_2__/* .MIN_BOOTLOADER_VERSION */ .w$, bootVer)) return;
            ...
            <div class="header-content">
                <div class="brand">
                    ...
                    <div class="header-left">
                        <h1>Kantinen Übersicht <small class="version-tag" style="font-size: 0.6em; opacity: 0.7; font-weight: 400; cursor: pointer;" title="Klick für Versionsmenü">v2.0.6<span style="font-size:0.55em;opacity:0.6;margin-left:4px">51b45d3</span></small></h1>
            ...
            <div class="modal-content">
                ...
                <div class="modal-body">
                    <div style="margin-bottom: 1rem;">
                        <strong>Aktuell:</strong> <span id="version-current">v2.0.6 <span style="font-size:0.8em;opacity:0.6">51b45d3</span></span>
                    </div>
...
if (!window.__KANTINE_LOADED) {
    ...
    stats_tracker/* tracker */.F.incrementCategory('version', 'v2.0.6');
