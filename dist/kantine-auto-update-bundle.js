...
const CLIENT_VERSION = 'v2.1.5';
const COMMIT_HASH = 'eca6598';
...
async function fetchDishImages(query, lang, cancelSignal) {
    ...
    try {
        const response = await fetch(constants/* DISH_IMAGE_WIKIPEDIA_URL */.nZ.replace('{q}', encodeURIComponent(query)), { signal: attemptSignal() })
        if (response.ok) {
            const summary = await response.json()
            const thumb = summary && summary.thumbnail && summary.thumbnail.source
            if (typeof thumb === 'string' && thumb.startsWith('http')) {
                const images = [{ url: thumb, license: '', creator: summary.title || query }].slice(0, constants/* DISH_IMAGE_MAX_RESULTS */.v0)
    ...
    try {
        const response = await fetch(constants/* DISH_IMAGE_COMMONS_URL */.Gm.replace('{q}', encodeURIComponent(query)), { signal: attemptSignal() })
        if (response.ok) {
            const data = await response.json()
...
function renderDishImageCarousel(query, result) {
    ...
    const sourceLabel = (0,i18n.t)({ wikipedia: 'dishImageSourceWikipedia', commons: 'dishImageSourceCommons', openverse: 'dishImageSourceOpenverse' }[result.source] || 'dishImageSourceGoogle');
            ...
            <div class="header-content">
                <div class="brand">
                    ...
                    <div class="header-left">
                        <h1>Kantinen Übersicht <small class="version-tag" style="font-size: 0.6em; opacity: 0.7; font-weight: 400; cursor: pointer;" title="Klick für Versionsmenü">v2.1.5</small></h1>
            ...
            <div class="modal-content">
                ...
                <div class="modal-body">
                    <div style="margin-bottom: 1rem;">
                        <strong>Aktuell:</strong> <span id="version-current">v2.1.5</span>
                    </div>
...
if (!window.__KANTINE_LOADED) {
    ...
    stats_tracker/* tracker */.F.incrementCategory('version', 'v2.1.5');
