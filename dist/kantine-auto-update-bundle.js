...
function createDayCard(day) {
    ...
    sortedItems.forEach(item => {
        ...
        if (rawDesc.trim()) {
            splitFeedbackButton = ` <button type="button" class="icon-btn icon-btn-small btn-split-feedback" aria-label="${(0,utils/* escapeHtml */.ZD)((0,i18n.t)('reportSplit'))}" title="${(0,utils/* escapeHtml */.ZD)((0,i18n.t)('reportSplitTooltip'))}"><span class="material-icons-round" aria-hidden="true">bug_report</span></button>`;
        }
            ...
            <div class="header-content">
                <div class="brand">
                    ...
                    <div class="header-left">
                        <h1>Kantinen Übersicht <small class="version-tag" style="font-size: 0.6em; opacity: 0.7; font-weight: 400; cursor: pointer;" title="Klick für Versionsmenü">v2.2.2</small></h1>
            ...
            <div class="modal-content">
                ...
                <div class="modal-body">
                    <div style="margin-bottom: 1rem;">
                        <strong>Aktuell:</strong> <span id="version-current">v2.2.2</span>
                    </div>
...
if (!window.__KANTINE_LOADED) {
    ...
    stats_tracker/* tracker */.F.incrementCategory('version', 'v2.2.2');
